...
const MEET_ROOMS: MeetRoom[] = [
  {
    ...
    shortUrl: 'meet.google.com/mrv-pknj-fbt',
  ...
  },
  {
    ...
    shortUrl: 'meet.google.com/qnt-uifv-rzk',
  ...
  },
  {
    ...
    shortUrl: 'meet.google.com/fzx-ymdw-khs',
...
export default function VideocallPage() {
  ...
  const [selectedRoomId, setSelectedRoomId] = useState<string>('team')
  const [inCall, setInCall] = useState(false)
  const [copied, setCopied] = useState(false)

  const currentRoom = MEET_ROOMS.find((r) => r.id === selectedRoomId) || MEET_ROOMS[0]
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            onClick={() =>
              window.open(provider === 'google_meet' ? currentRoom.url : jitsiRoomUrl, '_blank')
            }
        ...
        {provider === 'google_meet' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center p-4 sm:p-6 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-y-auto">
            <div className="text-center space-y-5 max-w-2xl w-full my-auto">
              ...
              {/* Card Dettaglio Stanza Selezionata */}
              <div className="bg-slate-900/90 border border-slate-800/80 rounded-2xl p-5 sm:p-6 text-center space-y-4 shadow-xl backdrop-blur-xs">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 pt-1">
                  <Button
                    ...
                    className="w-full sm:w-auto bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white font-bold shadow-lg shadow-sky-500/25 px-7 h-11 cursor-pointer text-xs sm:text-sm"
                  >
